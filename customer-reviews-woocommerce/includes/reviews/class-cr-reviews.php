...
/* This file needs to be updated in the Customer Reviews Woocommerce CusRev plugin similar 
to the folder path. It is the file that modifies the review section and there is no template.  
*/
	...
	public function show_summary_table( $product_id, $is_ajax = false, $new_reviews_allowed = false ) {
		...
		if( $all > 0 ) {
			...
			if( $five > 0 ) {
				...
				/*
				$output .= '<tr class="ivole-histogramRow">';
				$output .= '<td><i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i></td>';
				$output .= '</tr>';
				*/
				$output .= '<tr class="ivole-histogramRow">';
				$output .= '<td class="ivole-histogramCell1"><span class="ivole-histogram-a" data-rating="5">' . __( '', 'customer-reviews-woocommerce' ) . '</span>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<div class="ivole-histogram-a" data-rating="5"><div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $five_percent . '%">' . $five_percent . '</div></div></div>';
				$output .= '<span class="ivole-histogram-a" data-rating="5">' . $product->get_rating_count( 5 ) . ' (' . (string)$five_percent . '%)</span></td>';
				/* original code  
				...
				*/
				$output .= '<tr class="ivole-histogramRow">';
				$output .= '<td class="ivole-histogramCell1">' . __( '', 'customer-reviews-woocommerce' );
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $five_percent . '%"></div></div>';
				$output .= '<span class="ivole-histogram-a" data-rating="5">0 (' . (string)$five_percent . '%</td>';
			...
			if( $four > 0 ) {
				...
				*/
				$output .= '<tr class="ivole-histogramRow">';
				$output .= '<td class="ivole-histogramCell1"><span class="ivole-histogram-a" data-rating="4">' . __( '', 'customer-reviews-woocommerce' ) . '</span>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<div class="ivole-histogram-a" data-rating="4"><div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $four_percent . '%">' . $four_percent . '</div></div></div>';
				$output .= '<span class="ivole-histogram-a" data-rating="4">' . $product->get_rating_count( 4 ) . ' (' . (string)$four_percent . '%)</span></td>';
				...
				*/
				...
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $four_percent . '%"></div></div>';
				$output .=  '<span class="ivole-histogram-a" data-rating="4">0 (' . (string)$four_percent . '%)</td>';
			...
			if( $three > 0 ) {
				...
				*/
				...
				$output .= '<tr class="ivole-histogramRow">';
				$output .= '<td class="ivole-histogramCell1"><span class="ivole-histogram-a" data-rating="3">' . __( '', 'customer-reviews-woocommerce' ) . '</span>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<div class="ivole-histogram-a" data-rating="3"><div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $three_percent . '%">' . $three_percent . '</div></div></div>';
				$output .= '<span class="ivole-histogram-a" data-rating="3">' . $product->get_rating_count( 3 ) . ' (' . (string)$three_percent . '%)</span></td>';
				...
				*/
				...
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $three_percent . '%"></div></div>';
				$output .=  '<span class="ivole-histogram-a" data-rating="3">0 (' . (string)$three_percent . '%)</td>';
			...
			if( $two > 0 ) {
				...
				*/
				$output .= '<tr class="ivole-histogramRow">';
				$output .= '<td class="ivole-histogramCell1"><span class="ivole-histogram-a" data-rating="2">' . __( '', 'customer-reviews-woocommerce' ) . '</span>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<div class="ivole-histogram-a" data-rating="2"><div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $two_percent . '%">' . $two_percent . '</div></div></div>';
				$output .= '<span class="ivole-histogram-a" data-rating="2">' . $product->get_rating_count( 2 ) . ' (' . (string)$two_percent . '%)</span></td>';
				...
				*/
				...
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $two_percent . '%"></div></div>';
				$output .=  '<span class="ivole-histogram-a" data-rating="2">0 (' . (string)$two_percent . '%)</td>';
			}
			$output .= '</tr>';
			$output .= '<tr class="ivole-histogramRow">';
			if( $one > 0 ) {
				...
				*/
				$output .= '<tr class="ivole-histogramRow">';
				$output .= '<td class="ivole-histogramCell1"><span class="ivole-histogram-a" data-rating="1">' . __( '', 'customer-reviews-woocommerce' ) . '</span>';
				$output .= '<i class="fa fa-star"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<div class="ivole-histogram-a" data-rating="1"><div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $one_percent . '%">' . $one_percent . '</div></div></div>';
				$output .= '<span class="ivole-histogram-a" data-rating="1">' . $product->get_rating_count( 1 ) . ' (' . (string)$one_percent . '%)</span></td>';
				...
				*/
				...
				$output .= '<i class="fa fa-star-o"></i>';
				$output .= '<i class="fa fa-star-o"></i>';	
				$output .= '<div class="ivole-meter"><div class="ivole-meter-bar" style="width: ' . $one_percent . '%"></div></div>';
				$output .=  '<span class="ivole-histogram-a" data-rating="1">0 (' . (string)$one_percent . '%)</td>';
