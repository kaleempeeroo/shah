...
/* This file needs to be updated in the Customer Reviews for Woocommerce plugin in the templates
folder path.  It gets files from the /includes directory that displays reviews. */
